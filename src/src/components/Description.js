...
function Description() {
 ...
 <div class="descriptioncard">
  <img src={data.image[0]}  alt={data.image} className="productcardimage"/>
...
<div>
                    ...
                    <div class="descriptioncard">
                     <img src={data.image[1]} alt={data.image} className="productcardimage"/>
                   ...
                   <div>
                    ...
                    <div class="descriptioncard">
                     <img src={data.image[2]} alt={data.image} className="productcardimage"/>
  ...
  5 stars based on 2 reviews.
         ...
         <tr><td> STORAGE</td><td>{data.Storage}</td></tr>
         <tr><td>PROCESSOR</td><td>{data.processor}</td></tr>
         <tr><td>BATTERY LIFE</td><td>{data.Battery}</td></tr>
         <tr><td></td><td><h2 className="description">KSH:{data.price}</h2></td></tr>
